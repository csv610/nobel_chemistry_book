...
Fenn's development of electrospray ionization mass spectrometry made it possible to analyze large biomolecules, including proteins and DNA, transforming biology and medicine. Electrospray mass spectrometry is now a standard tool for protein identification, drug discovery, and clinical diagnostics, and underpins modern proteomics.
...
Tanaka's soft laser desorption method enabled mass spectrometry of large biomolecules, founding the field of biological mass spectrometry. His techniques evolved into MALDI mass spectrometry, now used to identify proteins, analyze polymers, and detect pathogens in clinical and biotechnological laboratories worldwide.
...
Wüthrich's development of multidimensional NMR methods for determining protein structures in solution founded the field of protein NMR and enabled the study of biomolecules under physiological conditions. NMR-based structural biology remains essential for understanding protein dynamics, drug binding, and the interactions of intrinsically disordered proteins.
