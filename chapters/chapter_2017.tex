...
Dubochet's development of vitrified (frozen-hydrated) specimen preparation made it possible to image biological samples in their native state with cryo-electron microscopy. His method, which vitrifies water so it does not form damaging ice crystals, is the foundation of modern cryo-EM, now a routine technique for determining the structures of proteins and viruses.
...
Frank's computational method for merging noisy 2D electron microscopy images into 3D reconstructions made cryo-electron microscopy practical. His algorithms transformed cryo-EM into a technique capable of atomic-resolution structures and underpin the modern revolution in structural biology that now routinely solves structures of membrane proteins and viruses.
...
Henderson's pioneering cryo-electron microscopy of proteins, including his demonstration that electron diffraction could yield atomic-resolution structures, proved that EM could rival X-ray crystallography. His work led to the modern cryo-EM revolution that now determines protein structures without crystals, reshaping structural biology and drug discovery.
