...
Anfinsen's demonstration that the amino acid sequence determines protein folding established the thermodynamic view of proteins and the protein-folding problem. His principle underpins modern protein engineering, the prediction of protein structure from sequence, and the design of new proteins. Anfinsen's ideas culminated in the AlphaFold revolution in structural biology.
...
Moore and Stein developed methods for the quantitative analysis of amino acids and the determination of the amino acid sequence of proteins, including the first complete sequence of ribonuclease. Their automated amino acid analyzers and sequencing methods laid the groundwork for the modern biotechnology industry and for the large-scale protein analysis used in proteomics today.
...
Moore and Stein's methods for analyzing amino acid composition and sequence made modern protein biochemistry possible and led to the first determination of the complete sequence of an enzyme, ribonuclease. Their automated analyzers evolved into today's protein sequencers and mass spectrometry-based proteomics, which are central to biology and medicine.
