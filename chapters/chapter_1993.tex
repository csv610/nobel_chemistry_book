...
Mullis's invention of the polymerase chain reaction (PCR) made it possible to amplify specific DNA sequences a billion-fold, transforming molecular biology and medicine. PCR underpins DNA fingerprinting, genetic testing, prenatal diagnostics, and the detection of infectious diseases, and was the essential enabling technology behind genomics, including the Human Genome Project.
...
Smith's site-directed mutagenesis, the technique of introducing specific changes into DNA, enabled the precise study of gene function and protein structure-activity relationships. His method founded modern protein engineering and is used to create enzymes, antibodies, and industrial biocatalysts, while also underpinning the directed evolution methods honored in 2018.
