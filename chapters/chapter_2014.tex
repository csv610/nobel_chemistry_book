...
Betzig's development of super-resolution fluorescence microscopy, including PALM, broke the diffraction limit and made it possible to image molecules and structures at the nanometer scale inside living cells. His techniques transformed cell biology and neuroscience, enabling the direct observation of individual proteins, synapses, and organelles.
...
Hell's development of STED super-resolution microscopy, together with his work on stimulated emission, broke the Abbe diffraction limit and allowed imaging of living cells with nanometer resolution. STED and related nanoscopy methods are now standard tools in cell biology, enabling the study of protein organization, synapses, and cellular dynamics.
...
Moerner's discovery that a single molecule could be detected and its fluorescence imaged at the single-molecule level founded the field of single-molecule spectroscopy and super-resolution imaging. His work enables the tracking of individual proteins, DNA, and enzymes in real time, underpinning modern biophysics and the super-resolution microscopes now used in biology.
