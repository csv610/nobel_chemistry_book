...
Goodenough's lithium-ion battery research, including his identification of the layered oxide cathodes used in commercial cells, enabled the rechargeable batteries that power smartphones, laptops, and electric vehicles. His work underlies the global transition to electric mobility and renewable energy storage, and his later iron phosphate and high-voltage materials continue to shape battery technology.
...
Whittingham's discovery of the reversible lithium intercalation in titanium disulfide demonstrated that lithium could be stored and released reversibly in a solid host, founding the lithium-ion battery. His work established the concept of intercalation electrodes that now power modern portable electronics and electric vehicles.
...
Yoshino's development of the first commercially viable lithium-ion battery, using carbon anodes and lithium cobalt oxide cathodes, created the technology that now powers smartphones, laptops, and electric vehicles. Lithium-ion batteries are central to the global transition to clean energy, and Yoshino's safety innovations enabled their mass production.
