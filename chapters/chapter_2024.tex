...
Baker's computational design of new proteins, using the Rosetta software he developed, founded the field of computational protein design. His methods have created enzymes, vaccines, and novel protein therapeutics, and his software underpins the modern biotechnology of designed proteins, including the engineered antigens now used in vaccines.
...
Hassabis's development of AlphaFold, an artificial intelligence system that predicts protein structures from amino acid sequences, transformed structural biology and computational biology. AlphaFold has predicted the structures of hundreds of millions of proteins, accelerating drug discovery, vaccine design, and the understanding of disease, and his work opened the era of AI-driven science.
...
Jumper's development of the AlphaFold2 neural network, which predicts protein structures at experimental accuracy, revolutionized the field of protein structure prediction. AlphaFold2 has been used by over a million researchers to model proteins for medicine, agriculture, and biotechnology, making structure prediction a routine tool of modern biology.
