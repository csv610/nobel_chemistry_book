...
Arnold's directed evolution of enzymes, which uses iterative rounds of mutation and selection to improve proteins, founded the field of protein engineering by evolutionary design. Her methods are now used industrially to create enzymes for pharmaceuticals, biofuels, and consumer products, and directed evolution is a cornerstone of modern synthetic biology and green chemistry.
...
Smith's invention of phage display, a method for displaying proteins and peptides on the surface of bacteriophages, made it possible to select proteins that bind specific targets. Phage display underpins modern antibody engineering, including the development of many therapeutic antibodies, and remains a central tool in protein and peptide discovery.
...
Winter's application of phage display to engineer human antibodies founded the field of antibody engineering and enabled the development of therapeutic antibodies. The humanized and fully human antibodies produced by his methods now treat cancer, autoimmune disease, and infections, and constitute a multi-billion-dollar class of biopharmaceuticals.
