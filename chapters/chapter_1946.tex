...
Sumner's crystallization of urease proved that enzymes are proteins and founded the modern field of enzymology. This landmark discovery enabled the industrialization of enzymes, which are now used in detergents, food processing, biofuels, and pharmaceutical synthesis. Protein purification and crystallization remain fundamental techniques in structural biology and drug discovery.
...
Northrop's crystallization of pepsin and other proteolytic enzymes demonstrated the general protein nature of enzymes and founded the modern enzyme industry. His methods for protein isolation and characterization underlie current biotechnology, including the production of recombinant enzymes, therapeutic proteins, and the crystallographic analysis that powers structure-based drug design.
...
Stanley's crystallization of tobacco mosaic virus opened the field of virology and showed that viruses could be studied as molecular entities. His work pioneered modern virology, leading to vaccines against polio, influenza, and COVID-19, and to the current understanding of viruses in human and plant disease. Stanley's isolation methods also influenced the development of modern protein and particle biochemistry.
