...
Eigen's use of relaxation techniques to measure ultra-fast chemical reactions revealed the kinetics of proton transfer and enzyme catalysis. His work founded fast-reaction chemistry and, through his later studies of self-organizing molecular systems, influenced the understanding of the origins of life and the development of the concept of RNA-like early replicators.
...
Norrish's photochemistry of radicals and his flash photolysis technique, developed with Porter, founded modern photochemistry and made it possible to observe short-lived reactive intermediates. Flash photolysis evolved into femtosecond spectroscopy and today's study of the fastest chemical processes, with applications in vision, photosynthesis, and materials science.
...
Porter's flash photolysis technique, developed with Norrish, revolutionized the study of fast reactions and enabled the direct observation of free radicals and excited states. His method evolved into the modern field of ultrafast spectroscopy, which today probes chemical reactions on the femtosecond timescale and underpins research in vision, photovoltaics, and photocatalysis.
