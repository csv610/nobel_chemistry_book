...
Karplus's molecular dynamics simulations of proteins, combining quantum and classical mechanics, founded the field of computational biochemistry. His methods are now used to study enzyme mechanisms, drug binding, and protein folding, and hybrid QM/MM techniques based on his work are standard tools in drug design and biophysics.
...
Levitt's coarse-grained models and his work on simulating protein dynamics and folding helped found the field of computational structural biology. His methods underpin the modern prediction and design of protein structures and were early steps toward the AlphaFold and Rosetta approaches used in biotechnology and medicine.
...
Warshel's development of QM/MM methods, combining quantum mechanics with molecular mechanics, made it possible to simulate chemical reactions in enzymes and complex molecular environments. His methods are now used worldwide to study enzyme catalysis, drug metabolism, and photochemistry and remain central tools in computational chemistry.
