...
Bawendi's development of methods for producing high-quality, monodisperse semiconductor nanocrystals (quantum dots) with controlled size and properties made quantum dots practical for research and industry. Quantum dots now illuminate displays, enable biomedical imaging, and are used in solar cells and photodetectors.
...
Brus's discovery that the optical properties of semiconductor nanocrystals depend on their size, now known as quantum confinement, founded the field of colloidal quantum dots. Quantum dots are now used in televisions and displays, biomedical imaging, and optoelectronics, and his work opened the field of nanoscience.
...
Yekimov's discovery of quantum size effects in glass-doped copper chloride crystals, the first clear demonstration of quantum confinement, founded the field of quantum dots. His work underpins the modern quantum dot industry used in displays, lighting, and biomedical imaging, and it opened the era of size-controlled semiconductor nanocrystals.
